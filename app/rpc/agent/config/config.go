...
type KafkaConfig struct {
	...
	ResumeTopic   string   `json:"resume_topic" yaml:"resume_topic"`
	JDTopic       string   `json:"jd_topic" yaml:"jd_topic"`
	QuestionTopic string   `json:"question_topic" yaml:"question_topic"`
}
